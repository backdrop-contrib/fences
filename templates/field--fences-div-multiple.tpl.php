<?php
/**
 * @file field--fences-div-multiple.tpl.php
 * Wrap a multi-value field in the <div> element.
 *
...
<?php foreach ($items as $delta => $item): ?>
  <div class="<?php print $classes; ?> field-item <?php print $delta % 2 ? 'odd' : 'even'; ?>"<?php print $attributes; ?>>
